...
(() => {
  ...
  class TitleScene extends Phaser.Scene {
    ...
    create() {
      ...
      // Title text
      const title = this.add.text(width / 2, height * 0.25, 'Rust × Node: gic_sec Adventure', {
        fontSize: '42px',
        fontFamily: 'Arial',
        color: '#ffffff',
        fontStyle: 'bold',
      ...
      // Subtitle
      this.add.text(width / 2, height * 0.35, 'Discover memory safety, speed and custom modules through play', {
        fontSize: '20px',
        fontFamily: 'Arial',
        color: '#aeeaff',
        align: 'center',
